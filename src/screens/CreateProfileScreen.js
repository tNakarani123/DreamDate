    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', marginTop: Height(20), marginLeft: Width(30) }}>
                ...
                <Text style={{ fontSize: Height(20), marginLeft: Width(30), fontFamily: 'Gilroy-SemiBold', color: '#8041C6' }}>Fill Your Profile</Text>
            </View>
            ...
            <ScrollView>
                <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"}>
                    ...
                    />
                    <Text style={{ color: 'black', fontFamily: 'Gilroy-SemiBold', fontSize: Height(12), marginTop: Height(10), marginLeft: Width(50) }}>Profession<Text style={{ color: '#FF115E', }}> *</Text></Text>
                    <TextInput
                    ...
                    <TextInput
                        ...
                        style={{
                            ...
                            fontSize: Height(16),
                            marginTop: Height(10),
                            borderColor: index === 8 ? '#8041C6' : '#a9a9a9'
                        }}
                        onFocus={() => setIndex(8)}
                    />
