        ...
        <SafeAreaView>
            ...
            >
                <View style={{
                    ...
                    <LogoComponent height={Height(105)} width={Width(114)} />
                </View>
            </DropShadow>
            <Text style={{ color: 'black', fontFamily: 'Gilroy-SemiBold', fontSize: Height(26), fontWeight: '500', textAlign: 'center', marginTop: Height(20) }}>Let's Sign You In</Text>
            ...
            <Text style={{ color: '#8041C6', fontFamily: 'Gilroy-SemiBold', fontSize: Height(14), marginLeft: Width(10), textAlign: 'center', marginTop: Height(20) }} onPress={() => navigation.navigate('ForgotPassword')}>Forgot password?</Text>
            <Text style={{ textAlign: 'center', fontSize: Height(14), fontFamily: 'Gilroy-SemiBold', color: 'black', marginTop: Height(10) }}>Or</Text>

            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginHorizontal: Width(20) }}>
            ...
            <Text style={{ textAlign: 'center', fontSize: Height(14), fontFamily: 'Gilroy-SemiBold', color: 'black', marginTop: Height(30) }}>Don't Have An Account? <Text style={{ color: '#8041C6' }} onPress={() => navigation.navigate('SignUp')}>Sign up</Text></Text>
        </SafeAreaView>
    )
}
